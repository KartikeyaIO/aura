...
# decode converts back. This means ProRes round-trip is NOT bit-exact.
CODECS = {
    "FFV1": {
        "ext": ".mkv",
...
def generate_test_matrix(seed=RANDOM_SEED, count=TOTAL_VIDEOS):
    """
    Generate a random test matrix of `count` video configurations.
    Each entry is a random combination of resolution x motion x color.
    """
